...
values ('NV01', N'Đào Thị Phương Thảo', N'Nữ', '2004-05-28', N'Ninh Bình', 'thaodtph45301@fpt.edu.vn', '0983299130',
        'thao2854', 'Thao2854@', N'Quản lý', N'Đang làm việc'),
       ('NV02', N'Vũ Thị Hoài Phương', N'Nữ', '2004-01-20', N'Ninh Bình', 'phuongvthph45125@fpt.edu.vn', '0983299131',
        'phuong123', 'Phuong1234@', N'Nhân viên', N'Đang làm việc'),
       ('NV03', N'Chử Đức Dũng', N'Nam', '2004-12-22', N'Phú Thọ', 'thaodtph45301@fpt.edu.vn', '0983299132', 'dung345',
        'Dung345@', N'Nhân viên', N'Nghỉ việc'),
       ('NV04', N'Hoàng Anh Tuấn', N'Nam', '2004-09-21', N'Nam Định', 'thaodtph45301@fpt.edu.vn', '0983299135',
        'tuan567', 'Tuan567@', N'Nhân viên', N'Đang làm việc');
...
INSERT INTO Voucher
VALUES ('VC02', N'Ưu đãi mùa xuân', '2024-04-13', '2024-04-20', 20, 15, 150000, 600000, N'Đang áp dụng');
INSERT INTO Voucher
VALUES ('VC03', N'Khuyến mãi hè', '2024-04-21', '2024-04-30', 25, 20, 100000, 700000, N'Đang áp dụng');
select*
from Voucher
