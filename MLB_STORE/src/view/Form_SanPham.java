...
public class Form_SanPham extends javax.swing.JPanel {
    ...
    public void showForm(SanPham sp) {
        ...
        String gt = (String) tbl_SanPham.getValueAt(index, 8);
        if (gt.equals("Đang bán")) {
            rd_DangBan.setSelected(true);
        }
        if (gt.equals("Dừng bán")) {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[]{btn_LamMoi, btn_Sua, btn_Them});
