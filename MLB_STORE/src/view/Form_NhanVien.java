...
public class Form_NhanVien extends javax.swing.JPanel {
    ...
    public boolean validateForm() {
        ...
        boolean hasHoa = !pass.equals(pass.toLowerCase());
        boolean hasThuong = !pass.equals(pass.toUpperCase());
        boolean hasSo = pass.matches(".*\\d.*");
        boolean hasKT = !pass.matches("[A-Za-z0-9]*");

        if (!hasHoa || !hasThuong || !hasSo || !hasKT) {
            JOptionPane.showMessageDialog(this, "Mật khẩu phải có kí tự đặc biệt");
            return false;
        }
